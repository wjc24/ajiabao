...
class Trade  extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('/settings/trade',['data'=>$new_goods,'like'=>$like,'sel'=>$sel,'page_now'=>$this->input->post('page_now'),'page_num'=>$page_num,'page_all'=>$page_all,'customer'=>$customer]);
    }
    ...
    public function add(){
        ...
        $this->load->view('/settings/trade_add',['id'=>$id,'good_name'=>$good_name,'max_num'=>$max_num]);
    }

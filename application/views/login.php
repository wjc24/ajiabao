...
<!--                        <input type="text" class="logininput" value="--><?php //echo get_cookie('username')?><!--" id="username" placeholder="用户名" />-->
<!--                    </div>-->
<!--                    <div class="loginInputc">-->
<!--                        <input type="password" class="logininput" id="password" value="--><?php //echo get_cookie('userpwd')?><!--" placeholder="密码" />-->
<!--                    </div>-->
<!--                </div>-->

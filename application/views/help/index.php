            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body faq">
                    ...
                    <div class="faq-item buy">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/1.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/1.png"/></a>
                            <p>
                                购货页签->购货单，可新建购货单<br>
                                ...
                                9、本次付款默认0，可以修改；单据保存时，如果（金额合计-本次付款）大于0，保存时将差额自动增加供应商的应付款。<br>
                                10、结算账户：将单据上“本次付款”中的金额统计到具体的账户；点击“多账户”，可录入多个结算账户进行付款。<br>
                                11、单据保存后，打印按钮才会显示出来。<br>
                            </p>
                        </div>
                    </div>
                    <div class="faq-item buy">
                        ...
                        <div class="faq-text">
                            <p>
                                ...
                                3、已确认：批量确认（确认后无修改权限则不可修改）当前列表中已勾选的单据；<br>
                    ...
                    <div class="faq-item sale">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/2.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/2.png"/></a>
                            <p>
                                ...
                                9、本次收款默认0，可以修改；单据保存时，如果（金额合计-本次收款）大于0，保存时将差额自动增加客户的应收款。  <br>
                                10、结算账户：将单据上“本次收款”中的金额统计到具体的账户；点击“多账户”，可录入多个结算账户进行收款。<br>
                                11、单据保存后，打印按钮才会显示出来。<br>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item storage">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/3.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/3.png"/></a>
                            <p>
                    ...
                    <div class="faq-item pandian">
                        ...
                        <div class="faq-text">
                            <p>
                                ...
                                <a href="<?php echo base_url()?>statics/images/4.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/4.png"/></a>
                            </p>
                        </div>
                    </div>
                    <!--其他入库单-->
                    <div class="faq-item otherWarehouse">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/18.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/18.png"/></a>
                            <p>
                    ...
                    <div class="faq-item otherOutbound">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/17.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/17.png"/></a>
                            <p>
...
<!--                    </div>-->
                    ...
                    <div class="faq-item receipt">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/23.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/23.png"/></a>
                            <a href="<?php echo base_url()?>statics/images/24.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/24.png"/></a>
                            <p>
                                1、新建收款单主要步骤：收款单可对应收记录进行核销 <br>
                    ...
                    <div class="faq-item payment">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/12.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/12.png"/></a>
                            <a href="<?php echo base_url()?>statics/images/13.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/13.png"/></a>
                            <p>
                                1、新建付款单主要步骤：付款单可对应付记录进行核销 <br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/8.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/8.png"/></a>
                            <p>
                                1、设置查询条件：<br>
...
<!--                    </div>-->
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/31.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/31.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/30.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/30.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                                A.客户、商品、仓库如果空表示查找所有客户、商品、仓库，可分别打开各选择框进行勾选；<br>
                                B.日期范围可以任意调整；<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/29.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/29.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                                A.客户、商品、仓库如果空表示查找所有客户、商品、仓库，可分别打开各选择框进行勾选；<br>
                                B.日期范围可以任意调整；<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/27.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/27.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/20.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/20.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/22.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/22.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                                A.商品、仓库如果空表示查找所有商品、仓库，可分别打开各选择框进行勾选；<br>
                                B.查询日期范围可以任意调整；<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/21.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/21.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                                A.商品、仓库如果空表示查找所有商品、仓库，可分别打开各选择框进行勾选；<br>
                                B.查询日期范围可以任意调整；<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/28.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/28.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/32.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/32.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/33.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/33.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                                A.客户如果空表示查找所有客户；<br>
                                B.查询日期范围可以任意调整；<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/15.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/15.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item reportForm">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/14.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/14.png"/></a>
                            <p>
                                1、设置查询条件：<br>
                    ...
                    <div class="faq-item set">
                        ...
                        <div class="faq-text">
                            <p>
                                ...
                                6、存货计价方法：默认为“移动平均法”；不能选择存货计价方法，还可以选择为“先进先出法”。<br>
                    ...
                    <div class="faq-item set">
                        ...
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/19.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/19.png"/></a>
                            <p>
                    ...
                    <div class="faq-item set">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/25.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/25.png"/></a>
                            <p>
                                2、首先选择授权的数据类别，如销售员只能查看指定客户，则选择数据类别为“客户”，点击“已启用”按钮，列表中出现所有客户，勾选该销售员能查看的客户，点“确定”授权完成。数据类别为“仓库”“供应商”的授权方法同上。
                            </p>
                            <a href="<?php echo base_url()?>statics/images/26.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/26.png"/></a>
<!--                            <p>-->
...
<!--                            <a href="--><?php //echo base_url()?><!--statics/images/数据授权3.png" class="flipLightBox"><img src="--><?php //echo base_url()?><!--statics/images/数据授权3.png"/></a>-->
                    ...
                    <div class="faq-item set">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/9.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/9.png"/></a>
                        </div>
                    </div>
                    <div class="faq-item set">
                        <div class="faq-title"><span class="fa fa-angle-down"></span>备份与恢复</div>
                        <div class="faq-text">
                            <a href="<?php echo base_url()?>statics/images/5.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/5.png"/></a>
                            <p>
...
<!--                    </div>-->
                    <div class="faq-item skill">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/16.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/16.png"/></a>
                        </div>
                    </div>
                    <div class="faq-item skill">
                        ...
                        <div class="faq-text">
                            ...
                            <a href="<?php echo base_url()?>statics/images/10.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/10.png"/></a>
                            <p>
                                2、在单据的“选择商品”对话框中，点击某商品操作列的查询图标，也可查询该商品的当前库存数量。
                            </p>
                            <a href="<?php echo base_url()?>statics/images/11.png" class="flipLightBox"><img src="<?php echo base_url()?>statics/images/11.png"/></a>
                        </div>
                    </div>
                </div>
                <!--内容end-->

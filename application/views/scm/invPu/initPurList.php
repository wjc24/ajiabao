...
<div class="wrapper">
  <div class="mod-search cf">
	...
	<div class="fr">
      ...
      <div class="ui-btn-menu">
          <a class="ui-btn menu-btn mrb" style="width: 50px;padding-right: 14px;" href="#" id="audit">已确认<b></b></a>
          <div class="con more-operate-con" style="margin-left: 10px;font-size: 14px;width: 68px;padding: 6px;">
            <ul class="more-operate cf" style="border-style:dashed; border-width:1px; border-color:#ccc;text-align: center;font-size: 15px;margin-left: -3px">
              <li><a href="#" id="reAudit">可修改</a></li>
            </ul>
          </div>
      </div>
    </div>
